...
import com.nest.settings.preferences.CustomSeekBarPreference;
...
public class HeaderSettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle icicle) {
        ...
        addPreferencesFromResource(R.xml.settings_customheader);
    ...
    @Override
    public boolean onPreferenceTreeClick(Preference preference) {if (preference == mFileHeader) {
